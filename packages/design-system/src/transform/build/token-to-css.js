...
StyleDictionary.extend({
  source: ['./src/transform/tokens/*.json'],
  platforms: {
    css: {
      buildPath: './src/styles/design-tokens/design-token-css/',
      // https://amzn.github.io/style-dictionary/#/transforms
      transforms: ['name/cti/kebab', 'scss/typography', 'scss/border', 'scss/box-shadow'],
      files: [
        {
        ...
        },
        {
          ...
          filter: (token) => /^fontFamilies$|^lineHeights$|^fontSizes$|^fontWeights$/.test(token.type),
        },
        {
